...
public class NetworkActivity extends Activity {
    ...
    /**
     *
     * @param minutes time to exceed for auto refresh page.
     * @return Did x minutes pass since last web page refresh?
     */
    private boolean timeGapCheckMinutes(int minutes) {
        long timeGap= System.currentTimeMillis()-timeLastRefreshed;
        return (timeGap > 1000 * 60 * minutes);
    }
